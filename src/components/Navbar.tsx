    ...
    return (
        <nav className={s.nav}>
            <ul className={s.linklist}>
                ...
                <li><NavLink className={({isActive}) => (isActive ? s.active : '')} to="/dialogues">Messages</NavLink>
                </li>
                ...
                <li><NavLink className={({isActive}) => (isActive ? s.active : '')} to="/settings">Settings</NavLink>
                </li>
            </ul>
        </nav>
    )
